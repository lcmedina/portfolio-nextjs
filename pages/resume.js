                ...
                <div className={styles.right}>
                    ...
                    <div className={styles.experience}>
                        <div className={styles.expHeading}>
                            <Image src="/icons/suitcase_lt.png" width={50} height={50} />
                            <h1 className={styles.heading}>Work Experience</h1>
                        </div>
                        <div className={styles.expDetails}>
                            <h2>Front Desk Admin | School of the Woods</h2>
                            <div className={styles.dates}>
                                <Image src="/icons/calendar_lt.png" width={25} height={25} />
                    ...
                    <div className={styles.experience}>
                        <div className={styles.expHeading}>
                            <Image src="/icons/education_lt.png" width={50} height={50} />
